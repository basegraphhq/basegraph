...
const changelogs: LogEntry[] = [
  {
    ...
    description: "Added GitLab authentication support. Connect your GitLab account to sync repositories and projects.",
    tag: "Feature"
  },
  {
    date: "Dec 4",
    title: "Design System Overhaul",
    description: "Implemented new design system with white page theme (Sierra). Refreshed UI components for a cleaner, more modern look.",
    tag: "Design"
  },
  {
    date: "Nov 30",
    title: "Dashboard Layout & Sidebar",
    description: "Redesigned dashboard layout with new sidebar navigation. Improved organization and easier access to features.",
    tag: "UI"
  },
  {
    date: "Nov 30",
    title: "Sync Card & Changelog",
    description: "Added sync status card and shipping logs panel. Stay updated with the latest changes and track your sync progress.",
    tag: "Feature"
  },
  {
    date: "Nov 29",
    title: "GitHub Authentication",
    description: "Added GitHub OAuth integration. Sign in with GitHub and automatically sync with waitlist upon login.",
    tag: "Feature"
  },
  {
    date: "Nov 27",
    title: "Google Authentication",
    description: "Added Google OAuth support. Multiple authentication options now available for seamless sign-in.",
    tag: "Feature"
  },
  {
    date: "Nov 26",
    title: "Dark Mode",
    description: "Introduced dark mode support. Toggle between light and dark themes for a comfortable viewing experience.",
    tag: "Feature"
  },
  {
    date: "Nov 26",
    title: "SEO Optimizations",
    description: "Enhanced SEO with improved metadata, sitemap, and performance optimizations. Better discoverability and search rankings.",
    tag: "Performance"
  },
  {
    date: "Nov 26",
    title: "Waitlist & Rate Limiting",
    description: "Added waitlist functionality with rate limiting. Secure and scalable user registration system.",
    tag: "Feature"
  }
]
